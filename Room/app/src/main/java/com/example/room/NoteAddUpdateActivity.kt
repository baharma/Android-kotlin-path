...
import com.example.room.databinding.ActivityNoteAddUpdateBinding
import com.example.room.helper.DateHelper
import com.example.room.viewmodel.NoteAddUpdateViewModel
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.btnSubmit?.setOnClickListener {
            ...
            val descriptor = binding?.edtDescription?.text.toString().trim()
            when{
                title.isEmpty() ->{
